      ...
      .map(res => {
        return res.json().collection.map(item => {
          return {
            ...
            imgUrl: item.track.artwork_url ? item.track.artwork_url.replace('large.jpg', 't200x200.jpg') : 'assets/img/SoundMooseSilver.png',
    ...
    return this._http.get(trackDetailsUrl)
      ...
      .map(item => {
        return {
            ...
            largeArtworkUrl: item.artwork_url ? item.artwork_url.replace('large.jpg', 't500x500.jpg') : 'assets/img/SoundMooseSilver.png',
            user: {
              id: item.user.id,
